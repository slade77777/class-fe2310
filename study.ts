...
function buyProduct(id: string, amount: number)  {
  // find object with id = input id with find function
  // new amount = current amount - input amount
  // save new amount
}
...
buyProduct("24", 10) // => id: 24 - amount = 73
